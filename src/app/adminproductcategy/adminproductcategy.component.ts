...
@Component({
  selector: 'app-adminproductcategy',
  templateUrl: './adminproductcategy.component.html',
  styleUrls: ['./adminproductcategy.component.css']
})
export class AdminproductcategyComponent implements OnInit {
  id = 0;
  formdata: any;
  name = "";
